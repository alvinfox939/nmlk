...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"TEMP_OUTPUT_SECTIONS" => array(
			"PARENT" => "TEMP",
			"NAME" => GetMessage("T_TEMP_OUTPUT_SECTIONS"),
			"TYPE" => "STRING",
			"DEFAULT" => 'subSection.php',
		),
		"TEMP_OUTPUT_ELEMETS" => array(
			"PARENT" => "TEMP",
			"NAME" => GetMessage("T_TEMP_OUTPUT_ELEMETS"),
			"TYPE" => "STRING",
			"DEFAULT" => 'element.php',
		),
		//section.start
		...
		"NEWS_COUNT" => array(
			...
			"TYPE" => "STRING",
			"DEFAULT" => "40",
            "HIDDEN" => (isset($arCurrentValues['NEWS_SHOW_SECTION']) && $arCurrentValues['NEWS_SHOW_SECTION'] == 'N' ? 'Y' : 'N'),
		),
		"SORT_BY1" => array(
			"PARENT" => "ELEMENTS",
		...
		"FIELD_CODE" => array_merge(
		    CIBlockParameters::GetFieldCode(GetMessage("IBLOCK_FIELD"),"ELEMENTS"),
            array("HIDDEN" => (isset($arCurrentValues['NEWS_SHOW_SECTION']) && $arCurrentValues['NEWS_SHOW_SECTION'] == 'N' ? 'Y' : 'N'))
        ),
		"PROPERTY_CODE" => array(
			"PARENT" => "ELEMENTS",
			"NAME" => GetMessage("T_IBLOCK_PROPERTY"),
